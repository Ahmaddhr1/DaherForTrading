// Named imports (rather than a default import) - node-cron ships a dual
// CJS/ESM package with a `default` export that doesn't reliably carry
// `.schedule`/`.validate` through Next's server webpack bundle, which
// crashed every request with "TypeError: e is not a function" at
// instrumentation time. The named exports avoid that interop hazard.
